...
import Main.CompareUserValuesLogin;
...
/**
 * Servlet implementation class CheckDbExists
 */
...
public class LoginCheck extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CompareUserValuesLogin cuv=new CompareUserValuesLogin();
		...
		x=cuv.CompareUserLogin(s.getUsername(),s.getPassword());
		...
		if(x==true) {
			...
			out.print(""
					+ "<meta http-equiv=\"refresh\" content=\"0; URL='User_menu.html'\" />");
			 ...
			 out.print("<!DOCTYPE html>\r\n" + 
			 		...
			 		"</body>\r\n" + 
			 		"</html>");
			 out.print("<meta http-equiv=\"refresh\" content=\"1; URL='Login_User.html'\" />");
