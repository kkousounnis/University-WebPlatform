...
import Main.CompareSecretaryValues;
...
/**
 * Servlet implementation class SecretaryLoginCheck
 */
@WebServlet("/SecretaryLoginCheck")
public class SecretaryLoginCheck extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SecretaryLoginCheck() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CompareSecretaryValues csv=new CompareSecretaryValues();
		...
		x=csv.CompareSecretaryLogin(s.getUsername(),s.getPassword());
		...
		if(x==true) {
			...
			out.print(""
					+ "<meta http-equiv=\"refresh\" content=\"0; URL='Secretary_menu.html'\" />");
			...
			out.print("<!DOCTYPE html>\r\n" + 
			 		...
			 		"</body>\r\n" + 
			 		"</html>"); 
			 out.print("<meta http-equiv=\"refresh\" content=\"1; URL='Secretary_Login.html'\" />");
